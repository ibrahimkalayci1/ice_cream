  ...
  return (
    ...
    >
      ...
      <div className='d-flex gap-2 mt-4 align-items-center'>
        ...
        className='btn btn-sm btn-outline-danger'>Azalt
        </button>
        <span data-testid="amount" className='fs-2'>{basketItem?.amount}</span>
        <button 
          onClick={() => addToBasket(item)}

        className='btn btn-sm btn-outline-success'>Ekle
        </button>
